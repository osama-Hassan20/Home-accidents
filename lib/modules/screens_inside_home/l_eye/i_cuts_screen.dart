              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: (){
                        navigateTo(context, a_EyeScreen());
                      },
                      child: Container(
                        child: ChapterCard(
                          name: "مقدمة",
                    ...
                    GestureDetector(
                      onTap: (){
                        navigateTo(context, b_EyeScreen());
                      },
                      child: ChapterCard(
                        name: "الأعراض",
                        press: () {navigateTo(context, b_EyeScreen());},
                      ),
                    ),
                    GestureDetector(
                      onTap: (){
                        navigateTo(context, c_EyeScreen());
                      },
                      child: ChapterCard(
                        name: "الإسعافات الأولية ",
                        press: () {navigateTo(context, c_EyeScreen());},
                      ),
                    ),
                    GestureDetector(
                      onTap: (){
                        navigateTo(context, d_EyeScreen());
                      },
                      child: ChapterCard(

                        name: "طرق الوقاية",
                        press: () {navigateTo(context, d_EyeScreen());},
                      ),
                    ),
